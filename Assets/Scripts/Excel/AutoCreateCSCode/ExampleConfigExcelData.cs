...
[Serializable]
public partial class ExampleConfigExcelItem : ExcelItemBase
{
	/// <summary>
	/// 数据id
	/// </summary>>
...
public partial class ExampleConfigExcelData : ExcelDataBase<ExampleConfigExcelItem>
{
	public ExampleConfigExcelItem[] items;

	public Dictionary<int,ExampleConfigExcelItem> itemDic = new Dictionary<int,ExampleConfigExcelItem>();
	...
	public ExampleConfigExcelItem GetExampleConfigExcelItem(int id)
	{
	...
	{
		var item = GetExampleConfigExcelItem(id);
		if(item == null)
			return default;
	...
	{
		var item0 = GetExampleConfigExcelItem (id);
		if(item0 == null)
			return default;
...
#if UNITY_EDITOR
public class ExampleConfigAssetAssignment
{
	public static bool CreateAsset(ExcelMediumData excelMediumData, string excelAssetPath)
	{
		...
		ExampleConfigExcelData excelDataAsset = ScriptableObject.CreateInstance<ExampleConfigExcelData>();
		excelDataAsset.items = new ExampleConfigExcelItem[rowCount];

		for(int i = 0; i < rowCount; i++)
		{
			var itemRowDic = allRowItemDicList[i];
			excelDataAsset.items[i] = new ExampleConfigExcelItem();
		...
		string fullPath = Path.Combine(excelAssetPath,typeof(ExampleConfigExcelData).Name) + ".asset";
