...
{
    [MenuItem("Tools/Excel Window",priority = 100)]
    ...
    private void Awake()
    {
        ...
        scriptSaveAbsolutePath = Application.dataPath + CheckEditorPath("/Scripts/Excel/AutoCreateCSCode");
        scriptSaveRelativePath = CheckEditorPath("Assets/Scripts/Excel/AutoCreateCSCode");
        //scriptSaveAbsolutePath = Application.dataPath + CheckEditorPath("/Plugins/Excel/Scripts/AutoCreateCSCode");
        //scriptSaveRelativePath = CheckEditorPath("Assets/Plugins/Excel/Scripts/AutoCreateCSCode");
        //assetSaveRelativePath = CheckEditorPath("Assets/AssetData/Excel/AutoCreateAsset");
        assetSaveRelativePath = CheckEditorPath("Assets/Resources/ScriptableObject/AutoCreateAsset");
